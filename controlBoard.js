...
let allianceIn = document.getElementById('allianceIn');
...
//Clears round and alliances
function cleary(){
  console.log("cleared")
  round = '';
  allianceIn.elements[0].value = '';
  allianceIn.elements[1].value = '';
}

//updates round file with current round
function roundInput() {
  fs.writeFile('ranks.js', 'let roundVal = "' + round + '"; \n' + 'let allianceAVal = "' + allianceIn.elements[0].value + '"; \n' + 'let allianceBVal = "' + allianceIn.elements[1].value + '";', (err) => {
    if (err) throw err;
    console.log('The file has been saved!');
  });
};
